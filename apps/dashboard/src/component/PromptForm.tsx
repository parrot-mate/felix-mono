import { Prompt, PromptFieldType, ModelNames } from "@pmate/meta"
    ...
    return (
      ...
      >
        ...
        <Collapse
          ...
          className="rounded-lg border border-slate-700 bg-slate-950/50"
          items={[
            {
              key: "messages",
              label: (
                            ...
                            <div className="flex items-center justify-between gap-3">
                              ...
                              >
                                <Select
                                  ...
                                  className="[&_.ant-select-selection-item]:font-semibold [&_.ant-select-selection-item]:text-primary-300"
                                />
                              </Form.Item>
                              <Button
                                danger
            ...
            },
            {
              key: "variables",
              label: (
                <span className="font-semibold text-slate-100">Variables</span>
              ),
              children: (
