...
export default {
  key: "reader/zh-CN/en/context-explain",
  title: "上下文解释：中句英讲",
  messages: [
    {
      role: "system",
      content: `You are a teacher helping a student learn Chinese. Based on the provided context, explain the sentence in English.`,
    },
    {
      role: "system",
      content: `这是关联的[上下文]:
