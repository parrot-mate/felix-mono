...
type UnwrapOr<T, U> = T extends Array<any>
  ? T
  : U extends undefined
  ? T | undefined
  : T | U
export class Loadable<T> {
  ...
  hasValue(): boolean {
    return this.isJust() || this.value !== undefined // has stale value
  }
